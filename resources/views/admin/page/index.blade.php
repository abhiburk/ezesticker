                                ...
                                @foreach ($pages as $item)
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <a href="{{ route('page.edit', ['page' => Helper::encodeId($item->id)] ) }}" class="btn btn-link">Edit</a>
                                            |
                                            <form class="delete-form" action="{{ route('page.destroy', ['page' => Helper::encodeId($item->id)] ) }}" method="POST">
                                                {{ method_field('DELETE') }}
                                                {!! csrf_field() !!}
